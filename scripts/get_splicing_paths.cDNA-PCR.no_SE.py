...
This script will identify possible splicing paths in IFRD2 and assign them a score based on the counts from chromatin RNA sequencing, filtering out SE events

Usage: python get_splicing_paths.cDNA-PCR.no_SE.py gene_names_df intron_df ctrl_1_multi_introns_counts ctrl_2_multi_introns_counts U2_1_multi_introns_counts U2_2_multi_introns_counts splicing_paths_no_SE
